...
public class AlgaeFarmLogic {
    ...
    public void update() {
        ...
        //褐藻
        if(metaTileEntity.fillChest(GTQTMetaItems.BROWN_ALGAE.getStackForm(x*Math.max(0,(CasingTier-2))), true))
        {
            metaTileEntity.fillChest(GTQTMetaItems.BROWN_ALGAE.getStackForm(x*Math.max(0,(CasingTier-2))), false);
        }
        else {
        ...
        //普通
        if(metaTileEntity.fillChest(GTQTMetaItems.COMMON_ALGAE.getStackForm(x*CasingTier), true))
        {
            metaTileEntity.fillChest(GTQTMetaItems.COMMON_ALGAE.getStackForm(x*CasingTier), false);
        }
        else {
            isInventoryFull = true;
            setActive(false);
        ...
        //绿藻
        if(metaTileEntity.fillChest(GTQTMetaItems.GREEN_ALGAE.getStackForm(x*CasingTier), true))
        {
            metaTileEntity.fillChest(GTQTMetaItems.GREEN_ALGAE.getStackForm(x*CasingTier), false);
        }
        else {
            isInventoryFull = true;
            setActive(false);
        ...
        //金藻
        if(metaTileEntity.fillChest(GTQTMetaItems.GOLD_ALGAE.getStackForm(x*Math.max(0,(CasingTier-4))), true))
        {
            metaTileEntity.fillChest(GTQTMetaItems.GOLD_ALGAE.getStackForm(x*Math.max(0,(CasingTier-4))), false);
        }
        else {
            isInventoryFull = true;
            setActive(false);
        ...
        //红藻
        if(metaTileEntity.fillChest(GTQTMetaItems.RED_ALGAE.getStackForm(x*Math.max(0,(CasingTier-5))/2), true))
        {
            metaTileEntity.fillChest(GTQTMetaItems.RED_ALGAE.getStackForm(x*Math.max(0,(CasingTier-5))/2), false);
        }
        else {
            isInventoryFull = true;
            setActive(false);

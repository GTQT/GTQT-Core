...
public class SimpleSteamMetaTileEntity extends SteamMetaTileEntity {
    ...
    protected TextureArea getCircuitSlotOverlay() {
        return GTQTTextures.INT_CIRCUIT_OVERLAY_STEAM.get(isHighPressure);
    }
    ...
    protected TextureArea[] getOverlaysForSlot(boolean isOutputs, boolean isFluid) {
        return new TextureArea[]{isFluid ? GTQTTextures.FLUID_SLOT_STEAM.get(isHighPressure) : GuiTextures.SLOT_STEAM.get(isHighPressure)};
    }
}

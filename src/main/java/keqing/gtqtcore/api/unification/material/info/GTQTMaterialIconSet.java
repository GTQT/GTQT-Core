...
public class GTQTMaterialIconSet {
    ...
    public static final MaterialIconSetWithRenderer CUSTOM_COSMIC_NEUTRONIUM = new MaterialIconSetWithRenderer("cosmic", null, true, new HaloRenderItemBehavior(10, 0x33FFFFFF, () -> GTQTTextures.HALO_NOISE, true));

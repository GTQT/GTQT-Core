...
public class GTQTAPI {
    ...
    public static final Object2ObjectOpenHashMap<IBlockState, IBlockTier> MAP_FIREBOX_CASING = new Object2ObjectOpenHashMap<>();
    ...
    public static final Object2ObjectOpenHashMap<IBlockState, IBlockTier> MAP_FORCE_FIELD_COIL = new Object2ObjectOpenHashMap<>();
    public static void init() {
        ...
        MAP_FIREBOX_CASING.put(MetaBlocks.BOILER_FIREBOX_CASING.getState(BlockFireboxCasing.FireboxCasingType.BRONZE_FIREBOX),
                new WrappedIntTired(BlockFireboxCasing.FireboxCasingType.BRONZE_FIREBOX, 1));

        MAP_FIREBOX_CASING.put(MetaBlocks.BOILER_FIREBOX_CASING.getState(BlockFireboxCasing.FireboxCasingType.STEEL_FIREBOX),
                new WrappedIntTired(BlockFireboxCasing.FireboxCasingType.STEEL_FIREBOX, 2));

        MAP_FIREBOX_CASING.put(GTQTMetaBlocks.FIREBOX_CASING.getState(keqing.gtqtcore.common.block.blocks.BlockFireboxCasing.FireboxCasingType.STAINLESS_STEEL_FIREBOX),
                new WrappedIntTired(keqing.gtqtcore.common.block.blocks.BlockFireboxCasing.FireboxCasingType.STAINLESS_STEEL_FIREBOX, 3));

        MAP_FIREBOX_CASING.put(MetaBlocks.BOILER_FIREBOX_CASING.getState(BlockFireboxCasing.FireboxCasingType.TITANIUM_FIREBOX),
                new WrappedIntTired(BlockFireboxCasing.FireboxCasingType.TITANIUM_FIREBOX, 4));

        MAP_FIREBOX_CASING.put(MetaBlocks.BOILER_FIREBOX_CASING.getState(BlockFireboxCasing.FireboxCasingType.TUNGSTENSTEEL_FIREBOX),
                new WrappedIntTired(BlockFireboxCasing.FireboxCasingType.TUNGSTENSTEEL_FIREBOX, 5));

        MAP_FIREBOX_CASING.put(GTQTMetaBlocks.FIREBOX_CASING.getState(keqing.gtqtcore.common.block.blocks.BlockFireboxCasing.FireboxCasingType.RHODIUM_PLATED_PALLADIUM_FIREBOX),
                new WrappedIntTired(keqing.gtqtcore.common.block.blocks.BlockFireboxCasing.FireboxCasingType.RHODIUM_PLATED_PALLADIUM_FIREBOX, 6));

        MAP_FIREBOX_CASING.put(GTQTMetaBlocks.FIREBOX_CASING.getState(keqing.gtqtcore.common.block.blocks.BlockFireboxCasing.FireboxCasingType.NAQUADAH_ALLOY_FIREBOX),
                new WrappedIntTired(keqing.gtqtcore.common.block.blocks.BlockFireboxCasing.FireboxCasingType.NAQUADAH_ALLOY_FIREBOX, 7));

        MAP_FIREBOX_CASING.put(GTQTMetaBlocks.FIREBOX_CASING.getState(keqing.gtqtcore.common.block.blocks.BlockFireboxCasing.FireboxCasingType.DARMSTADTIUM_FIREBOX),
                new WrappedIntTired(keqing.gtqtcore.common.block.blocks.BlockFireboxCasing.FireboxCasingType.DARMSTADTIUM_FIREBOX, 8));

        MAP_FIREBOX_CASING.put(GTQTMetaBlocks.FIREBOX_CASING.getState(keqing.gtqtcore.common.block.blocks.BlockFireboxCasing.FireboxCasingType.NEUTRONIUM_FIREBOX),
                new WrappedIntTired(keqing.gtqtcore.common.block.blocks.BlockFireboxCasing.FireboxCasingType.NEUTRONIUM_FIREBOX, 9));

        MAP_FORCE_FIELD_COIL.put(blockActiveUniqueCasing.getState(BlockActiveUniqueCasing.ActiveCasingType.FORCE_FIELD_CONSTRAINT_COIL),
                new WrappedIntTired(BlockActiveUniqueCasing.ActiveCasingType.FORCE_FIELD_CONSTRAINT_COIL, 1));

        MAP_FORCE_FIELD_COIL.put(GTQTMetaBlocks.blockActiveUniqueCasing.getState(BlockActiveUniqueCasing.ActiveCasingType.ADVANCED_FORCE_FIELD_CONSTRAINT_COIL),
                new WrappedIntTired(BlockActiveUniqueCasing.ActiveCasingType.ADVANCED_FORCE_FIELD_CONSTRAINT_COIL, 2));

        MAP_FORCE_FIELD_COIL.put(GTQTMetaBlocks.blockActiveUniqueCasing.getState(BlockActiveUniqueCasing.ActiveCasingType.ELITE_FORCE_FIELD_CONSTRAINT_COIL),
                new WrappedIntTired(BlockActiveUniqueCasing.ActiveCasingType.ELITE_FORCE_FIELD_CONSTRAINT_COIL, 3));

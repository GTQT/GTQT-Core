    ...
    public static void init() {
        ...
        for (int i = 1; i <= 5; i++) {
            RecipeMaps.ASSEMBLER_RECIPES.recipeBuilder()
                    ...
                    .inputs(GTUtility.copy((int) Math.pow(2, i), forming))
                    .inputs(GTUtility.copy((int) Math.pow(2, i), breaking))
                    .fluidInputs(Glue[i+1].getFluid(288))
                    .outputs(GTUtility.copy((int) Math.pow(4, i), meInterface))
                    .EUt(VA[HV + i])
                    .duration(200)
                    .buildAndRegister();
            ...
            RecipeMaps.ASSEMBLER_RECIPES.recipeBuilder()
                    ...
                    .inputs(GTUtility.copy((int) Math.pow(2, i), breaking))
                    .fluidInputs(Glue[i+1].getFluid(288))
                    .outputs(GTUtility.copy((int) Math.pow(4, i), meFluidInterface))
                    .EUt(VA[HV + i])
                    .duration(200)
                    .buildAndRegister();
        }
        ...
        for (int i = 1; i <= 5; i++) {
            RecipeMaps.ASSEMBLER_RECIPES.recipeBuilder()
                    ...
                    .circuitMeta(2)
                    .fluidInputs(Glue[i+1].getFluid(288))
                    .outputs(GTUtility.copy((int) Math.pow(4, i - 1), molecularAssembler))
                    .EUt(VA[HV + i])
                    .duration(200)
                    .buildAndRegister();
        }

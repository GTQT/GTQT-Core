...
public class MagnetoResonaticCircuits {
    ...
    private static void Circuits() {
        ...
        CIRCUIT_ASSEMBLER_RECIPES.recipeBuilder()
                ...
                .input(SMD_TRANSISTOR, 16)
                .input(SMD_DIODE, 16)
                .fluidInputs(HighGradeSolderingAlloy.getFluid(864))
        ...
        CIRCUIT_ASSEMBLER_RECIPES.recipeBuilder()
                ...
                .fluidInputs(HighGradeSolderingAlloy.getFluid(1008))
        ...
        CIRCUIT_ASSEMBLER_RECIPES.recipeBuilder()
                ...
                .input(ADVANCED_SMD_TRANSISTOR, 24)
                .input(ADVANCED_SMD_DIODE, 24)
                .fluidInputs(HighGradeSolderingAlloy.getFluid(4608))
        ...
        CIRCUIT_ASSEMBLER_RECIPES.recipeBuilder()
                ...
                .fluidInputs(HighGradeSolderingAlloy.getFluid(5184))
        ...
        CIRCUIT_ASSEMBLER_RECIPES.recipeBuilder()
                ...
                .fluidInputs(GTQTMaterials.MutantActiveSolder.getFluid(5760))
        ...
        CIRCUIT_ASSEMBLER_RECIPES.recipeBuilder()
                ...
                .fluidInputs(GTQTMaterials.MutantActiveSolder.getFluid(6336))
        ...
        CIRCUIT_ASSEMBLER_RECIPES.recipeBuilder()
                ...
                .fluidInputs(GTQTMaterials.MutantActiveSolder.getFluid(6912))
        ...
        CIRCUIT_ASSEMBLER_RECIPES.recipeBuilder()
                ...
                .fluidInputs(GTQTMaterials.MutantActiveSolder.getFluid(7488))
        ...
        CIRCUIT_ASSEMBLER_RECIPES.recipeBuilder()
                ...
                .fluidInputs(GTQTMaterials.MutantActiveSolder.getFluid(8064))
        ...
        CIRCUIT_ASSEMBLER_RECIPES.recipeBuilder()
                ...
                .fluidInputs(GTQTMaterials.MutantActiveSolder.getFluid(8640))

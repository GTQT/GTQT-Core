...
import static keqing.gtqtcore.api.recipes.GTQTcoreRecipeMaps.LATEX_COLLECTOR_RECIPES;
import static keqing.gtqtcore.api.recipes.GTQTcoreRecipeMaps.SALT_FLIED;
...
public class MiscMachineRecipes {
    ...
    public static void init() {
        ...
        EXTRACTOR_RECIPES.recipeBuilder().EUt(VA[IV]).duration(100)

...
public class EnzymesRecipes {
    ...
    public static void init() {
        ...
        */
        //格式 小消耗细菌 原材料 输出材料
        //普适矿处菌种	1	倍产铁 铜 锡	HV
        SpecialOut(Enzymesaa,10,crushed,Iron,1,dust,Iron,4,1,10);
        SpecialOut(Enzymesaa,10,crushed,BandedIron,1,dust,Iron,4,1,10);
        SpecialOut(Enzymesaa,10,crushed,BrownLimonite,1,dust,Iron,4,1,10);
        SpecialOut(Enzymesaa,10,crushed,Chromite,1,dust,Iron,4,1,10);
        SpecialOut(Enzymesaa,10,crushed,Magnetite,1,dust,Iron,4,1,10);
        SpecialOut(Enzymesaa,10,crushed,Pyrite,1,dust,Iron,4,1,10);
        SpecialOut(Enzymesaa,10,crushed,YellowLimonite,1,dust,Iron,4,1,10);

        SpecialOut(Enzymesaa,10,crushed,Pentlandite,1,dust,Nickel,4,1,10);

        SpecialOut(Enzymesaa,10,crushed,Copper,1,dust,Copper,4,1,10);
        SpecialOut(Enzymesaa,10,crushed,Chalcopyrite,1,dust,Copper,4,1,10);
        SpecialOut(Enzymesaa,10,crushed,Bornite,1,dust,Copper,4,1,10);
        SpecialOut(Enzymesaa,10,crushed,Chalcocite,1,dust,Copper,4,1,10);
        SpecialOut(Enzymesaa,10,crushed,Tetrahedrite,1,dust,Copper,4,1,10);

        SpecialOut(Enzymesaa,10,crushed,Tin,1,dust,Tin,4,1,10);
        SpecialOut(Enzymesaa,10,crushed,Cassiterite,1,dust,Tin,4,1,10);
        SpecialOut(Enzymesaa,10,crushed,CassiteriteSand,1,dust,Tin,4,1,10);

        SpecialOut(Enzymesaa,10,crushed,Aluminium,1,dust,Aluminium,4,1,10);
        SpecialOut(Enzymesaa,10,crushed,Almandine,1,dust,Aluminium,4,1,10);
        SpecialOut(Enzymesaa,10,crushed,Grossular,1,dust,Aluminium,4,1,10);
        SpecialOut(Enzymesaa,10,crushed,Pyrope,1,dust,Aluminium,4,1,10);
        SpecialOut(Enzymesaa,10,crushed,Spessartine,1,dust,Aluminium,4,1,10);
        SpecialOut(Enzymesaa,10,crushed,Amblygonite,1,dust,Aluminium,4,1,10);
        SpecialOut(Enzymesaa,10,crushed,Bauxite,1,dust,Aluminium,4,1,10);

        //定向铂系菌种	2	倍产金 银 铂系	EV
        SpecialOut(Enzymesab,10,crushed,Gold,1,dust,Gold,4,1,20);
        SpecialOut(Enzymesab,10,crushed,Silver,1,dust,Silver,4,1,20);
        ...
        // 普适副产菌种	2	倍产副产（暂定HV前的矿）	HV
        SpecialOutCircuit(Enzymesad,10,1,crushed,Aluminium,1,dust, Rutile,2,2,20);

        SpecialOutCircuit(Enzymesad,10,1,crushed,Copper,1,dust, Gold,2,1,20);
        SpecialOutCircuit(Enzymesad,10,2,crushed,Copper,1,dust, Cobalt,2,1,20);

        SpecialOutCircuit(Enzymesad,10,1,crushed,Magnetite,1,dust, Gold,2,1,20);

        SpecialOutCircuit(Enzymesad,10,1,crushed,Pyrite,1,dust, Sulfur,2,1,20);

        SpecialOutCircuit(Enzymesad,10,1,crushed,Gold,1,dust, Copper,2,1,20);
        SpecialOutCircuit(Enzymesad,10,2,crushed,Gold,1,dust, Silver,2,1,20);

        SpecialOutCircuit(Enzymesad,10,1,crushed,Silver,1,dust, Gold,2,1,20);
        SpecialOutCircuit(Enzymesad,10,2,crushed,Silver,1,dust, Lead,2,1,20);

        SpecialOutCircuit(Enzymesad,10,1,crushed,Galena,1,dust, Silver,2,1,20);
        SpecialOutCircuit(Enzymesad,10,2,crushed,Galena,1,dust, Sulfur,2,1,20);

        SpecialOutCircuit(Enzymesad,10,1,crushed,Iron,1,dust, Gold,2,1,20);
        SpecialOutCircuit(Enzymesad,10,2,crushed,Iron,1,dust, Nickel,2,1,20);
        SpecialOutCircuit(Enzymesad,10,3,crushed,Iron,1,dust, Zinc,2,1,20);

        SpecialOutCircuit(Enzymesad,10,1,crushed,Lead,1,dust, Nickel,2,1,20);

        SpecialOutCircuit(Enzymesad,20,1,crushed,Nickel,1,dust, Platinum,2,2,40);

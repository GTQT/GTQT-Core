...
public class TechReSearchNET {
    ...
    public static void init() {
        ...
        //2 涡轮效率升级II 小火箭
        KQ_NET(0, 2, 2, DISK_2, COMBUSTION_GENERATOR[3].getStackForm());
        KQ_NET(0, 2, 2, DISK_2, GAS_TURBINE[3].getStackForm());
        KQ_NET(0, 2, 2, DISK_2, STEAM_TURBINE[4].getStackForm());
        //3 涡轮效率升级III 特大轮机
        KQ_NET(0, 3, 3, DISK_3, EXTREME_COMBUSTION_ENGINE.getStackForm());
        KQ_NET(0, 3, 3, DISK_3, LARGE_COMBUSTION_ENGINE.getStackForm());
        //4 蒸燃联合体系 爆燃 大火箭
        KQ_NET(0, 2, 4, DISK_4, COMBUSTION_GENERATOR[4].getStackForm());
        KQ_NET(0, 2, 4, DISK_4, GAS_TURBINE[4].getStackForm());
        KQ_NET(0, 2, 4, DISK_4, STEAM_TURBINE[4].getStackForm());
        //5 室温超导设计
    ...
    private static void VVI_VVVV() {
        ...
        ASSEMBLY_LINE_RECIPES.recipeBuilder()
                ...
                .fluidInputs(MolybdeniteLubricant.getFluid(4000))
                .stationResearch(b -> b
        ...
        ASSEMBLY_LINE_RECIPES.recipeBuilder()
                ...
                .input(rotor, RhodiumPlatedPalladium, 16)
        ...
        ASSEMBLY_LINE_RECIPES.recipeBuilder()
                ...
                .outputs(GTQTMetaBlocks.blockActiveUniqueCasing.getItemVariant(FORCE_FIELD_CONSTRAINT_COIL))
                .EUt(VA[UV])
                .duration(50 * SECOND)
                .stationResearch(b -> b
                        .researchStack(DISK_26.getStackForm())
        ...
        ASSEMBLY_LINE_RECIPES.recipeBuilder()
                ...
                .input(cableGtQuadruple, Europium, 64)
                .input(cableGtQuadruple, Europium, 64)
                .fluidInputs(BlackTitanium.getFluid(L * 32))
        ...
        ASSEMBLY_LINE_RECIPES.recipeBuilder()
                ...
                .fluidInputs(NaquadahAlloy.getFluid(L * 32))
                .fluidInputs(Kevlar.getFluid(L * 16))
                .fluidInputs(HighGradeSolderingAlloy.getFluid(20 * L))
                .fluidInputs(MolybdeniteLubricant.getFluid(4000))
                .stationResearch(b -> b
        ...
        ASSEMBLY_LINE_RECIPES.recipeBuilder()
                ...
                .output(AE_FLUIX_FIRM, 8)
                .scannerResearch(b -> b.researchStack(DISK_11.getStackForm()).duration(1200).EUt(VA[MV]))
        ...
        ASSEMBLY_LINE_RECIPES.recipeBuilder()
                ...
                .fluidInputs(Lubricant.getFluid(GTValues.L * 4))
                .fluidInputs(Polyethylene.getFluid(GTValues.L * 4))
                .output(AE_FLUIX_NET, 8)
                .scannerResearch(b -> b.researchStack(DISK_12.getStackForm()).duration(1200).EUt(VA[HV]))
                .duration(100).buildAndRegister();
        ...
        ASSEMBLY_LINE_RECIPES.recipeBuilder()
                ...
                .fluidInputs(Lubricant.getFluid(GTValues.L * 4))
                .fluidInputs(Polyethylene.getFluid(GTValues.L * 4))
                .output(AE_FLUIX_BOOSTER, 8)
                .scannerResearch(b -> b.researchStack(DISK_13.getStackForm()).duration(1200).EUt(VA[EV]))
                .duration(100).buildAndRegister();
        ...
        ASSEMBLY_LINE_RECIPES.recipeBuilder()
                ...
                .input(OPTICAL_PIPES[0], 64)
                .fluidInputs(VanadiumGallium.getFluid(L * 32))
                .fluidInputs(Polybenzimidazole.getFluid(L * 16))
    ...
    private static void Pre() {
        ...
        ASSEMBLY_LINE_RECIPES.recipeBuilder()
                ...
                .fluidInputs(Epoxy.getFluid(L * 32))
                .fluidInputs(Brominatedepoxyresins.getFluid(L * 16))
                .fluidInputs(SolderingAlloy.getFluid(L * 5))
                .fluidInputs(Lubricant.getFluid(1000))
                .scannerResearch(b -> b
                        .researchStack(DISK_17.getStackForm())
        ...
        ASSEMBLY_LINE_RECIPES.recipeBuilder()
                ...
                .fluidInputs(NaquadahAlloy.getFluid(L * 2))
                .fluidInputs(HighGradeSolderingAlloy.getFluid(2 * L))
                .stationResearch(b -> b
        ...
        ASSEMBLY_LINE_RECIPES.recipeBuilder()
                ...
                .input(wireFine, Ruridit, 64)
                .input(wireGtSingle, LuVSuperconductor, 64)
                .fluidInputs(NiobiumTitanium.getFluid(L * 32))
                .fluidInputs(Polybenzimidazole.getFluid(L * 16))
                .fluidInputs(HighGradeSolderingAlloy.getFluid(20 * L))
                .fluidInputs(MolybdeniteLubricant.getFluid(4000))
        ...
        ASSEMBLY_LINE_RECIPES.recipeBuilder()
                ...
                .fluidInputs(CobaltBrass.getFluid(L * 10))
                .fluidInputs(SolderingAlloy.getFluid(L * 5))
                .fluidInputs(Lubricant.getFluid(1000))
        ...
        ASSEMBLY_LINE_RECIPES.recipeBuilder()
                ...
                .fluidInputs(WatertightSteel.getFluid(L * 40))
                .fluidInputs(NaquadahEnriched.getFluid(L * 20))
                .fluidInputs(HighGradeSolderingAlloy.getFluid(20 * L))
    ...
    private static void I_VV() {
        ...
        ASSEMBLY_LINE_RECIPES.recipeBuilder()
                ...
                .fluidInputs(SolderingAlloy.getFluid(L * 5))
                .fluidInputs(Lubricant.getFluid(1000))
                .outputs(COMBUSTION_GENERATOR[3].getStackForm())
                .scannerResearch(b -> b
        ...
        ASSEMBLY_LINE_RECIPES.recipeBuilder()
                ...
                .fluidInputs(SolderingAlloy.getFluid(L * 5))
                .fluidInputs(Lubricant.getFluid(1000))
                .outputs(COMBUSTION_GENERATOR[4].getStackForm())
                .scannerResearch(b -> b
                        .researchStack(DISK_1.getStackForm())
                        .duration(1200)
                        .EUt(VA[IV]))
        ...
        ASSEMBLY_LINE_RECIPES.recipeBuilder()
                ...
                .fluidInputs(SolderingAlloy.getFluid(L * 5))
                .fluidInputs(Lubricant.getFluid(1000))
                .outputs(GAS_TURBINE[3].getStackForm())
                .scannerResearch(b -> b
                        .researchStack(DISK_1.getStackForm())
                        .duration(1200)
                        .EUt(VA[EV]))
        ...
        ASSEMBLY_LINE_RECIPES.recipeBuilder()
                ...
                .fluidInputs(SolderingAlloy.getFluid(L * 5))
                .fluidInputs(Lubricant.getFluid(1000))
                .outputs(GAS_TURBINE[4].getStackForm())
                .scannerResearch(b -> b
                        .researchStack(DISK_1.getStackForm())
                        .duration(1200)
                        .EUt(VA[IV]))
        ...
        ASSEMBLY_LINE_RECIPES.recipeBuilder()
                ...
                .fluidInputs(SolderingAlloy.getFluid(L * 5))
                .fluidInputs(Lubricant.getFluid(1000))
                .outputs(STEAM_TURBINE[3].getStackForm())
                .scannerResearch(b -> b
                        .researchStack(DISK_1.getStackForm())
                        .duration(1200)
                        .EUt(VA[EV]))
        ...
        ASSEMBLY_LINE_RECIPES.recipeBuilder()
                ...
                .fluidInputs(SolderingAlloy.getFluid(L * 5))
                .fluidInputs(Lubricant.getFluid(1000))
                .outputs(STEAM_TURBINE[4].getStackForm())
                .scannerResearch(b -> b
                        .researchStack(DISK_1.getStackForm())
                        .duration(1200)
                        .EUt(VA[IV]))
        ...
        ASSEMBLY_LINE_RECIPES.recipeBuilder()
                ...
                .fluidInputs(Kevlar.getFluid(GTValues.L * 8))
                .fluidInputs(HighGradeSolderingAlloy.getFluid(5 * L))
        ...
        ASSEMBLY_LINE_RECIPES.recipeBuilder()
                ...
                .fluidInputs(RhodiumPlatedPalladium.getFluid(L * 16))
                .fluidInputs(Zylon.getFluid(GTValues.L * 8))
                .fluidInputs(SolderingAlloy.getFluid(L * 5))
                .fluidInputs(Lubricant.getFluid(1000))
                .stationResearch(b -> b
        ...
        ASSEMBLY_LINE_RECIPES.recipeBuilder()
                .EUt(VA[LuV])
                .input(ROCKET_ENGINE[2], 16)
                .input(frameGt, Materials.TungstenCarbide, 32)
                .input(ELECTRIC_PISTON_LUV, 32)
                .input(ELECTRIC_MOTOR_LuV, 32)
                .input(circuit, Tier.ZPM, 4)
                .input(circuit, Tier.LuV, 8)
                .input(circuit, Tier.IV, 16)
                .input(wireGtDouble, IndiumTinBariumTitaniumCuprate, 32)
                .input(plate, Inconel792, 16)
        ...
        ASSEMBLY_LINE_RECIPES.recipeBuilder()
                .EUt(VA[ZPM])
                .input(LARGE_ROCKET_ENGIN, 16)
                .input(frameGt, Materials.TungstenCarbide, 32)
                .input(ELECTRIC_PISTON_ZPM, 32)
                ...
                .input(plate, Inconel792, 16)
                .input(plate, Materials.NiobiumTitanium, 16)
                .input(cableGtQuadruple, Osmium, 32)
                .fluidInputs(Materials.Trinium.getFluid(GTValues.L * 24))
                .fluidInputs(Materials.VanadiumGallium.getFluid(GTValues.L * 8))
                .fluidInputs(SolderingAlloy.getFluid(L * 10))
                .fluidInputs(Lubricant.getFluid(2000))
                .outputs(EXTREME_LARGE_ROCKET_ENGIN.getStackForm())
                .scannerResearch(b -> b
                        .researchStack(DISK_4.getStackForm())
                        .duration(1200)
                        .EUt(VA[LuV]))
        ...
        ASSEMBLY_LINE_RECIPES.recipeBuilder()
                ...
                .fluidInputs(Uranium.getFluid(GTValues.L * 16))
                .fluidInputs(Polybenzimidazole.getFluid(GTValues.L * 8))
                .fluidInputs(HighGradeSolderingAlloy.getFluid(5 * L))
                .fluidInputs(MolybdeniteLubricant.getFluid(1000))
        ...
        ASSEMBLY_LINE_RECIPES.recipeBuilder()
                ...
                .fluidInputs(VanadiumGallium.getFluid(L * 16))
                .fluidInputs(Niobium.getFluid(L * 16))
                .fluidInputs(HighGradeSolderingAlloy.getFluid(10 * L))
                .fluidInputs(MolybdeniteLubricant.getFluid(2000))
        ...
        ASSEMBLY_LINE_RECIPES.recipeBuilder()
                ...
                .fluidInputs(KaptonE.getFluid(L * 10))
                .fluidInputs(HighGradeSolderingAlloy.getFluid(10 * L))
                .fluidInputs(MolybdeniteLubricant.getFluid(2000))

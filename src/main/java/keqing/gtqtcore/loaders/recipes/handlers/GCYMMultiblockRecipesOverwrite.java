...
public class GCYMMultiblockRecipesOverwrite {
    ...
    private static void multiblocks() {
        ...
        ASSEMBLY_LINE_RECIPES.recipeBuilder()
                ...
                .input(pipeNormalFluid, StainlessSteel, 4)
                .input(spring, Tritanium, 32)
                .input(plate, Europium, 16)
                .input(plate, Staballoy, 16)
                .input(wireFine, Osmium, 32)
                .input(cableGtSingle, Neutronium, 64)
                ...
                .output(GTQTMetaTileEntities.LARGE_ION_IMPLANTATOR)
                .EUt(VA[UV])
                .duration(1200)
                .scannerResearch(b -> b
                        .researchStack(DISK_21.getStackForm())
        ...
        ASSEMBLY_LINE_RECIPES.recipeBuilder()
                ...
                .fluidInputs(Lubricant.getFluid(4000))
                .fluidInputs(SolderingAlloy.getFluid(L * 20))
                .output(GTQTMetaTileEntities.LARGE_EUV_MASK_ALIGNER)
                .EUt(VA[EV])
                .duration(1200)
                .scannerResearch(b -> b
                        .researchStack(DISK_21.getStackForm())

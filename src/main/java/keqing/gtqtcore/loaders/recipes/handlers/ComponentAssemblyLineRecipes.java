...
public class ComponentAssemblyLineRecipes {
    ...
    private static void Motor() {
        ...
        COMPONENT_ASSEMBLY_LINE_RECIPES.recipeBuilder()
                ...
                .fluidInputs(MolybdeniteLubricant.getFluid(16000))
        ...
        COMPONENT_ASSEMBLY_LINE_RECIPES.recipeBuilder()
                ...
                .input(stickLong, CosmicNeutronium, 64)
                .input(stickLong, CosmicNeutronium, 64)
                .input(stickLong, CosmicNeutronium, 64)
                .input(stickLong, CosmicNeutronium, 64)
                .input(cableGtHex, Europium, 8) // cable
                .fluidInputs(SolderingAlloy.getFluid(L * 8 * 64))
                .fluidInputs(MolybdeniteLubricant.getFluid(192000))
                .fluidInputs(Vibranium.getFluid(L * 64))
                .fluidInputs(CosmicNeutronium.getFluid(17408))
        ...
        COMPONENT_ASSEMBLY_LINE_RECIPES.recipeBuilder()
                ...
                .fluidInputs(MolybdeniteLubricant.getFluid(320000))
                .fluidInputs(Polyetheretherketone.getFluid(L * 2 * 64))
                .fluidInputs(Ichorium.getFluid(L * 64))
                .fluidInputs(Infinity.getFluid(17408))
    ...
    private static void Piston() {
        ...
        COMPONENT_ASSEMBLY_LINE_RECIPES.recipeBuilder()
                ...
                .fluidInputs(MolybdeniteLubricant.getFluid(192000))
                .fluidInputs(Vibranium.getFluid(L * 64))
                .fluidInputs(CosmicNeutronium.getFluid(25600))
        ...
        COMPONENT_ASSEMBLY_LINE_RECIPES.recipeBuilder()
                ...
                .fluidInputs(Polyetheretherketone.getFluid(L * 2 * 64))
                .fluidInputs(Ichorium.getFluid(L * 64))
                .fluidInputs(Infinity.getFluid(25600))
    ...
    private static void Conveyor() {
        ...
        for (FluidStack stack : new FluidStack[]{
            ...
            COMPONENT_ASSEMBLY_LINE_RECIPES.recipeBuilder()
                    ...
                    .input(ELECTRIC_MOTOR_UHV, 64)
                    .input(plateDouble, CosmicNeutronium, 64)
                    .input(stickLong, CosmicNeutronium, 32)
    ...
    private static void RobotArm() {
        ...
        COMPONENT_ASSEMBLY_LINE_RECIPES.recipeBuilder()
                ...
                .fluidInputs(MolybdeniteLubricant.getFluid(192000))
                .fluidInputs(Vibranium.getFluid(L * 64))
                .fluidInputs(CosmicNeutronium.getFluid(L * 4 * 64 + L * 3 * 64)) // Gear + 3 Small Gear
        ...
        COMPONENT_ASSEMBLY_LINE_RECIPES.recipeBuilder()
                ...
                .fluidInputs(Polyetheretherketone.getFluid(L * 2 * 64))
                .fluidInputs(Ichorium.getFluid(L * 64))
                .fluidInputs(Infinity.getFluid(L * 4 * 64 + L * 3 * 64)) // Gear + 3 Small Gear
    ...
    private static void Emitter() {
        ...
        COMPONENT_ASSEMBLY_LINE_RECIPES.recipeBuilder()
                .circuitMeta(6)
                .input(frameGt, CosmicNeutronium, 64)
                .input(ELECTRIC_MOTOR_UHV, 64)
                .input(GRAVI_STAR, 64)
                .input(GRAVI_STAR, 64)
                .input(WRAP_CIRCUIT_UHV, 2) // 8 * 16 = 2 * 64
                ...
                .fluidInputs(CosmicNeutronium.getFluid(L * 4 * 64)) // long stick
        ...
        COMPONENT_ASSEMBLY_LINE_RECIPES.recipeBuilder()
                ...
                .fluidInputs(Infinity.getFluid(L * 4 * 64)) // long stick

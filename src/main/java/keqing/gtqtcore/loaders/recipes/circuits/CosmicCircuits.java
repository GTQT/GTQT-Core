...
/*
    ...
    private static void SMDs() {
        ...
        ASSEMBLER_RECIPES.recipeBuilder()
                ...
                .output(COSMIC_SMD_TRANSISTOR, 32)
                .EUt(VA[UEV])
                .duration(8 * SECOND)
                .cleanroom(CleanroomType.CLEANROOM)
                .buildAndRegister();
        ...
        PLASMA_CVD_RECIPES.recipeBuilder()
                ...
                .input(plate, Rhugnor)
                .fluidInputs(Zylon.getFluid(L * 2))
                .output(COSMIC_SMD_CAPACITOR, 32)
                .EUt(VA[UEV])
                .duration(8 * SECOND)
                .cleanroom(CleanroomType.CLEANROOM)
                .buildAndRegister();
    ...
    private static void Circuits() {
        ...
        CIRCUIT_ASSEMBLER_RECIPES.recipeBuilder()
                ...
                .input(COSMIC_SMD_RESISTOR, 8)
                .input(COSMIC_SMD_CAPACITOR, 8)
                .input(COSMIC_SMD_TRANSISTOR, 8)
                .input(wireFine, Infinity, 8)
                .solderMultiplier(1)
                .output(COSMIC_PROCESSOR_UEV, 2)
                .EUt(VA[UIV])
                .duration(10 * SECOND)
                .cleanroom(CleanroomType.CLEANROOM)
                .buildAndRegister();
        ...
        CIRCUIT_ASSEMBLER_RECIPES.recipeBuilder()
                .input(COSMIC_INFORMATION_MODULE)
                .input(COSMIC_PROCESSOR_UEV, 2)
                .input(COSMIC_SMD_INDUCTOR, 6)
                .input(COSMIC_SMD_CAPACITOR, 12)
                .input(COSMIC_MEMORY_CHIP, 24)
                .input(wireFine, Infinity, 16)
                .solderMultiplier(2)
                .output(COSMIC_ASSEMBLY_UIV, 2)
                .EUt(VA[UIV])
                .duration(20 * SECOND)
                .cleanroom(CleanroomType.CLEANROOM)
                .buildAndRegister();
        ...
        ASSEMBLY_LINE_RECIPES.recipeBuilder()
                .input(COSMIC_INFORMATION_MODULE)
                .input(COSMIC_ASSEMBLY_UIV, 2)
                .input(COSMIC_SMD_DIODE, 8)
                ...
                .output(COSMIC_COMPUTER_UXV)
                .stationResearch(b -> b
                        .researchStack(COSMIC_ASSEMBLY_UIV.getStackForm())
                        .EUt(VA[UIV])
                        .CWUt(256))
                .duration(20 * SECOND)
                .EUt(VA[UIV])
        ...
        ASSEMBLY_LINE_RECIPES.recipeBuilder()
                ...
                .stationResearch(b -> b
                        .researchStack(COSMIC_COMPUTER_UXV.getStackForm())
                        .EUt(VA[UXV])
                        .CWUt(512))

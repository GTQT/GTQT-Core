...
public class MetaTileEntityLargeRocketEngine extends FuelMultiblockController implements ProgressBarMultiblock {
    ...
    protected void configureDisplayText(MultiblockUIBuilder builder) {
        var recipeLogic = (LargeRocketEngineWorkableHandler) recipeMapWorkable;
    ...
    @Override
    public void addInformation(ItemStack stack, @Nonnull World player, List<String> tooltip, boolean advanced) {

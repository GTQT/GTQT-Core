...
import keqing.gtqtcore.api.capability.GTQTDataCodes;
...
public class MetaTileEntityEvaporationPool extends RecipeMapMultiblockController {
    ...
    protected static IBlockState getEvaporationBedState() {
        return GTQTMetaBlocks.blockEvaporationBed.getDefaultState();
    }
    ...
    public boolean isBlockEdge(World world, BlockPos.MutableBlockPos pos,
    ...
    public List<MultiblockShapeInfo> getMatchingShapes() {
        ...
        MultiblockShapeInfo.Builder builder = MultiblockShapeInfo.builder()
                ...
                .where('S', GTQTMetaTileEntities.EVAPORATION_POOL, EnumFacing.SOUTH)
        ...
        MultiblockDisplayText.builder(textList, isStructureFormed())
                ...
                .addCustom(tl -> {
                    ...
                    if (isStructureFormed()) {
                        ITextComponent isHeatingString = isHeating() ?
                                TextComponentUtil.translationWithColor(
                                        ...
                                        "gtqtcore.multiblock.evaporation_pool.is_heating") :
                                TextComponentUtil.translationWithColor(
                                        TextFormatting.RED,
                                        "gtqtcore.multiblock.evaporation_pool.is_not_heating");
                        tl.add(TextComponentUtil.translationWithColor(
                                TextFormatting.GRAY,
                                "gtqtcore.multiblock.evaporation_pool_heated_preface",
                                isHeatingString));
                    }
                    ...
                    if (isStructureFormed()) {
                        ...
                        tl.add(TextComponentUtil.translationWithColor(
                                TextFormatting.GRAY,
                                "gtqtcore.multiblock.evaporation_pool.exposed_blocks",
                                exposedBlocksString));
                    }
                    ...
                    if (isStructureFormed()) {
                        ...
                        tl.add(TextComponentUtil.translationWithColor(
                                TextFormatting.GRAY,
                                "gtqtcore.multiblock.evaporation_pool.average_speed",
                                averageSpeedString));
                    }
                })
    ...
    public void addInformation(ItemStack stack, World player, List<String> tooltip, boolean advanced) {
        ...
        tooltip.add(I18n.format("gtqtcore.machine.evaporation_pool.tooltip.info", MAX_DIAMETER, MIN_DIAMETER));
        if (TooltipHelper.isShiftDown()) {
            tooltip.add(I18n.format("gtqtcore.machine.evaporation_pool.tooltip.structure_info", MAX_DIAMETER, MIN_DIAMETER));
        }
    }
    ...
    public class EvapRecipeLogic extends MultiblockRecipeLogic {
        ...
        protected void updateRecipeProgress() {
            if (this.canRecipeProgress) {
                ...
                if (this.isHalted != halted) {
                    ...
                    writeCustomData(GTQTDataCodes.UPDATE_WORK_HALTED, buf -> buf.writeBoolean(halted));
                }
        ...
        public void receiveCustomData(int dataId, PacketBuffer buf) {
            super.receiveCustomData(dataId, buf);
            if (dataId == GTQTDataCodes.UPDATE_WORK_HALTED) {

...
import static keqing.gtqtcore.client.textures.GTQTTextures.MAINTENANCE_OVERLAY_ISO3_CLEANING;
...
public class MetaTileEntityISO3CleaningMaintenanceHatch extends MetaTileEntityAutoMaintenanceHatch {
    ...
    public void renderMetaTileEntity(CCRenderState renderState, Matrix4 translation, IVertexOperation[] pipeline) {
        ...
        if (shouldRenderOverlay())
            MAINTENANCE_OVERLAY_ISO3_CLEANING.renderSided(getFrontFacing(), renderState, translation, pipeline);
    }
    ...
    public void getSubItems(CreativeTabs creativeTab, NonNullList<ItemStack> subItems) {
        if (ConfigHolder.machines.enableMaintenance) {
            ...
            subItems.add(GTQTMetaTileEntities.ISO3_CLEANING_MAINTENANCE_HATCH.getStackForm());
        }
    }

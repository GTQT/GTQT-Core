...
public class MetaTileEntityPrimitiveTreeFarmer extends MultiblockWithDisplayBase implements IFastRenderMetaTileEntity {
    ...
    protected BlockPattern createStructurePattern() {
        return FactoryBlockPattern.start(RelativeDirection.RIGHT, RelativeDirection.BACK, RelativeDirection.UP)
                ...
                .where('B', states(GTQTMetaBlocks.blockMultiblockCasing4.getState(BlockMultiblockCasing4.TurbineCasingType.BRICK)))
                ...
                .where('O', states(GTQTMetaBlocks.blockMultiblockCasing4.getState(BlockMultiblockCasing4.TurbineCasingType.BRICK))
                        .or(metaTileEntities(MetaTileEntities.ITEM_EXPORT_BUS[0]).setMaxGlobalLimited(2).setMinGlobalLimited(2)))
                .where('I', states(GTQTMetaBlocks.blockMultiblockCasing4.getState(BlockMultiblockCasing4.TurbineCasingType.BRICK))

...
public class MetaTileEntityGeneratorHatch extends MetaTileEntityMultiblockNotifiablePart
        implements IMultiblockAbilityPart<IItemHandlerModifiable> {

    private final IItemHandlerModifiable machineHandler;

    public MetaTileEntityGeneratorHatch(ResourceLocation metaTileEntityId, int tier) {
    ...
    public MetaTileEntity createMetaTileEntity(IGregTechTileEntity tileEntity) {
        return new MetaTileEntityGeneratorHatch(metaTileEntityId, getTier());
    }
    ...
    private class LimitedImportHandler extends NotifiableItemStackHandler {
        ...
        public int getSlotLimit(int slot) {
            return MetaTileEntityGeneratorHatch.this.getMachineLimit();
        }

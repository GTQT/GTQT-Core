...
public class MetaTileEntityLargeExtruder extends GTQTRecipeMapMultiblockController {
    ...
    public void receiveCustomData(int dataId, PacketBuffer buf) {
        ...
        if (dataId == GTQTValue.UPDATE_TIER33) {
            this.casingTier = buf.readInt();
        }
        if (dataId == GTQTValue.REQUIRE_DATA_UPDATE33) {
            this.writeCustomData(GTQTValue.UPDATE_TIER33, buf1 -> buf1.writeInt(this.casingTier));
        }
    }

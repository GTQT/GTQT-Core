        ...
        if (page == 0) {
            ...
            if (card == 1) {
                ...
                if (thresholdPercentage == 0)
                    textList.add(new TextComponentTranslation("gtqtcore.multiblock.kqn.bio0"));
                if (thresholdPercentage <= 15 && thresholdPercentage > 0) {
                    textList.add(new TextComponentTranslation("gtqtcore.multiblock.kqn.bio1"));
                ...
                if (thresholdPercentage > 15)
                    textList.add(new TextComponentTranslation(String.format("gtqtcore.multiblock.kqn.bio%s", thresholdPercentage)));
            }
        }
        if (page == 1) {

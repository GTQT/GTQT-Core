...
public class MetaTileEntityISO2CleaningMaintenanceHatch extends MetaTileEntityAutoMaintenanceHatch {
    ...
    public void renderMetaTileEntity(CCRenderState renderState, Matrix4 translation, IVertexOperation[] pipeline) {
        ...
        if (shouldRenderOverlay())
            GTQTTextures.MAINTENANCE_OVERLAY_ISO2_CLEANING.renderSided(getFrontFacing(), renderState, translation, pipeline);
    }
    ...
    public void getSubItems(CreativeTabs creativeTab, NonNullList<ItemStack> subItems) {
        if (ConfigHolder.machines.enableMaintenance) {
            ...
            subItems.add(GTQTMetaTileEntities.ISO2_CLEANING_MAINTENANCE_HATCH.getStackForm());
        }
    }

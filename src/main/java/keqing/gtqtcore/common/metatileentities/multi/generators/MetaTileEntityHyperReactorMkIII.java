...
import static keqing.gtqtcore.common.block.blocks.BlockMultiblockCasing4.TurbineCasingType.HYPER_CIRE_MK3;
...
public class MetaTileEntityHyperReactorMkIII extends FuelMultiblockController implements IProgressBarMultiblock {
    ...
    public MetaTileEntityHyperReactorMkIII(ResourceLocation metaTileEntityId) {
        super(metaTileEntityId, GTQTcoreRecipeMaps.HYPER_REACTOR_MK3_RECIPES, OpV);
    ...
    protected void addDisplayText(List<ITextComponent> textList) {
        ...
        MultiblockDisplayText.builder(textList, this.isStructureFormed())
                ...
                .addEnergyProductionLine(V[MAX], recipeLogic.getRecipeEUt())
    ...
    public void addInformation(ItemStack stack,
        ...
        tooltip.add(I18n.format("gregtech.universal.tooltip.base_production_eut", GTValues.V[OpV]));
        tooltip.add(I18n.format("gtqtcore.machine.hyper_reactor_mk3.tooltip.boost", GTValues.V[OpV] * 4L));
                ...
                .where('C', states(getCasingState())
                        ...
                        .or(metaTileEntities(MultiblockAbility.REGISTRY.get(MultiblockAbility.OUTPUT_ENERGY).stream()
                                .filter(mte -> {
                                    ...
                                    return container != null && container.getOutputVoltage() <= GTValues.V[MAX];})
    ...
    private static IBlockState getUniqueCasingState() {
        return GTQTMetaBlocks.blockMultiblockCasing4.getState(HYPER_CIRE_MK3);
    }
    ...
    protected void formStructure(PatternMatchContext context) {
        ...
        this.boostAllowed = energyContainer != null && energyContainer.getOutputVoltage() >= GTValues.V[MAX];
    }
    ...
    private static class HyperReactorMark3WorkableHandler extends MultiblockFuelRecipeLogic {
        ...
        public long getMaxVoltage() {
            return this.isBoosted ? V[OpV] * 2L : V[OpV];
        }

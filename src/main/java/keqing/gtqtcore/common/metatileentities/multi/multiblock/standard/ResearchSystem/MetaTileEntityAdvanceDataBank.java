...
public class MetaTileEntityAdvanceDataBank extends MultiblockWithDisplayBase implements IControllable {
    ...
    public MetaTileEntity createMetaTileEntity(IGregTechTileEntity tileEntity) {
        return new MetaTileEntityAdvanceDataBank(metaTileEntityId);
    }
    ...
    public ICubeRenderer getBaseTexture(IMultiblockPart sourcePart) {
        if (sourcePart != null) {
            ...
            if (sourcePart instanceof IDataAccessHatch) {
                return GTQTTextures.ADV_COMPUTER_CASING;
            } else {
                return GTQTTextures.ULTRA_POWER_CASING;
            }
        } else {

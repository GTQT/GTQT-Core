...
public class MetaTileEntityISO1CleaningMaintenanceHatch extends MetaTileEntityAutoMaintenanceHatch {
    ...
    static {
        ...
        CLEANED_TYPES.add(GTQTCleanroomType.ISO2);
        CLEANED_TYPES.add(GTQTCleanroomType.ISO1);
    }
    ...
    public void renderMetaTileEntity(CCRenderState renderState, Matrix4 translation, IVertexOperation[] pipeline) {
        ...
        if (shouldRenderOverlay())
            GTQTTextures.MAINTENANCE_OVERLAY_ISO1_CLEANING.renderSided(getFrontFacing(), renderState, translation, pipeline);
    }
    ...
    public void getSubItems(CreativeTabs creativeTab, NonNullList<ItemStack> subItems) {
        if (ConfigHolder.machines.enableMaintenance) {
            ...
            subItems.add(GTQTMetaTileEntities.ISO1_CLEANING_MAINTENANCE_HATCH.getStackForm());
        }
    }
